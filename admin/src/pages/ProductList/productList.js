        ...
        try {
            ...
            await axiosClient.post("/uploadFile", formData, {
                ...
                const categoryList = {
                    ...
                    "caseThickness": values.caseThickness,
                    "movement": values.movement,
                    "powerReserve": values.powerReserve,
                    "waterResistance": values.waterResistance,
                    "winding": values.winding,
                    "color": values.colors
        ...
        (async () => {
            try {
                ...
                form2.setFieldsValue({
                    ...
                    quantity: response.product.quantity,
                    beats: response.product.beats,
                    caseSize: response.product.caseSize,
                    caseThickness: response.product.caseThickness,
                    movement: response.product.movement,
                    powerReserve: response.product.powerReserve,
                    waterResistance: response.product.waterResistance,
                    Winding: response.product.Winding,
                ...
                >
                    ...
                    "winding": values.winding, */}
                        ...
                        <Form.Item
                            ...
                            style={{ marginBottom: 10 }}
                        >
                            <Input placeholder="CASE THICKNESS" />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            style={{ marginBottom: 10 }}
                        >
                            <Input placeholder="POWER RESERVE" />
                        </Form.Item>
                        ...
                        <Form.Item
                            ...
                            style={{ marginBottom: 10 }}
                        >
                            <Input placeholder="WATER RESISTANCE" />
                        </Form.Item>
