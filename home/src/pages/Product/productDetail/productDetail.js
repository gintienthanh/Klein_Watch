                    ...
                    <div className="product_detail">
                                                ...
                                                <div class="policy">
                                                    <ul class="policy__list">
                                                        <li>
                                                            ...
                                                            <p>
                                                                Hư gì đổi nấy <b>12 tháng</b>  tại KleinWatch (miễn phí tháng đầu) <a href="#"></a>
                        ...
                        <div>
                            <Descriptions title="Thông số kỹ thuật" bordered>
                                <Descriptions.Item label="BEATS">{productDetail.beats}</Descriptions.Item>
                                <Descriptions.Item label="CASE SIZE">{productDetail.caseSize}</Descriptions.Item>
                                <Descriptions.Item label="CASE THICKNESS">{productDetail.caseThickness}</Descriptions.Item>
                                <Descriptions.Item label="MOVEMENT">{productDetail.movement}</Descriptions.Item>
                                <Descriptions.Item label="POWER RESERVE">{productDetail.powerReserve}</Descriptions.Item>
                                <Descriptions.Item label="WATER RESISTANCE">{productDetail.waterResistance}</Descriptions.Item>
                                <Descriptions.Item label="WINDING">{productDetail.winding}</Descriptions.Item>
                            </Descriptions>
                        </div>
